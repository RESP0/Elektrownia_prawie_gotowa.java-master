...
public class ListyElektrowni implements Serializable {
    ...
    public ArrayList<Elektrownia> elektrownieAtomowe = new ArrayList<>(){
        {
            add(new ElektrowniaAtomowa("Nazwa1","Miasto1", 100, 4000, 3, 4, wlasciciele.getWlasciciele().get(0), false, 86, 897, dystrybutorzy.getDystrybutorzyPradu().get(0), 345,dostawcy.odbiocyOdpadow.get(1), 20000, 10000, 500));
            add(new ElektrowniaAtomowa("Nazwa2","Miasto2", 100, 5000, 3, 4, wlasciciele.getWlasciciele().get(0), false, 86, 897, dystrybutorzy.getDystrybutorzyPradu().get(1), 345, dostawcy.odbiocyOdpadow.get(1), 22000, 12000, 700));
            add(new ElektrowniaAtomowa("Nazwa3","Miasto3", 100, 5500, 3, 4, wlasciciele.getWlasciciele().get(0), false, 86, 897, dystrybutorzy.getDystrybutorzyPradu().get(2), 345, dostawcy.odbiocyOdpadow.get(1), 24000, 14000, 900));
            add(new ElektrowniaAtomowa("Nazwa4","Miasto4", 100, 6500, 3, 4, wlasciciele.getWlasciciele().get(0), false, 86, 897, dystrybutorzy.getDystrybutorzyPradu().get(3), 345, dostawcy.odbiocyOdpadow.get(1), 26000, 16000, 1100));
            add(new ElektrowniaAtomowa("Nazwa5","Miasto5", 100, 8000, 3, 4, wlasciciele.getWlasciciele().get(0), false, 86, 897, dystrybutorzy.getDystrybutorzyPradu().get(4), 345, dostawcy.odbiocyOdpadow.get(1), 28000, 18000, 1300));
        }
    };

    public ArrayList<Elektrownia> elektrownieFotowoltaiczne = new ArrayList<>(){
        {
            add(new ElektrowniaFotowoltaiczna("Farma Boba Energetyka", "Wilkowo", 100, 550, 10, 10, wlasciciele.getWlasciciele().get(3), false, 0, dystrybutorzy.getDystrybutorzyPradu().get(0), 4000, 1000, 200));
            add(new ElektrowniaFotowoltaiczna("Datong Solar Power", "Shanxi", 100, 845, 10, 10, wlasciciele.getWlasciciele().get(3), false, 0, dystrybutorzy.getDystrybutorzyPradu().get(1), 5000, 2000, 300));
            add(new ElektrowniaFotowoltaiczna("Kurnool Ultra Mega Solar Park", "Panyam", 100, 1125, 10, 10, wlasciciele.getWlasciciele().get(3), false, 0, dystrybutorzy.getDystrybutorzyPradu().get(2), 6000, 3000, 400));
            add(new ElektrowniaFotowoltaiczna("Benban Solar Park", "Benban", 100, 1500, 10, 10, wlasciciele.getWlasciciele().get(3), false, 0, dystrybutorzy.getDystrybutorzyPradu().get(3), 7000, 4000, 500));
            add(new ElektrowniaFotowoltaiczna("Bhadla Solar Park", "Bhadla", 100, 2000, 10, 10, wlasciciele.getWlasciciele().get(3), false, 0, dystrybutorzy.getDystrybutorzyPradu().get(4), 8000, 5000, 600));
        }
    };
